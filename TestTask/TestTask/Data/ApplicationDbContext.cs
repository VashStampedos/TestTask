        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>().HasData(
                new Order[]
                {
                    ...
                    new Order {Id=11, ProductName="Potato", Price=3, Quantity=100, UserId=1},
                    new Order {Id=12, ProductName="Carrot", Price=9, Quantity=15, UserId=1},
                    new Order {Id=13, ProductName="Onion", Price=100, Quantity=15, UserId=1},
